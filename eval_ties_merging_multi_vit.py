        ...
        for scale_number in range(1,21):
            ...
            for mr_number in range(11):    
                ...
                for p, m_c, m_m, d, dm in zip(merged_model_paths, upstream_models, merged_models, dataloaders, all_datasets):
                    ...
                    m_m = mm.get_merged_model(merged_model=m_m, models_to_merge=upstream_models, exclude_param_names_regex =  exclude_param_names_regex, param_value_mask_rate = mr, scaling_coefficient = scale, models_use_deepcopy = True)   
